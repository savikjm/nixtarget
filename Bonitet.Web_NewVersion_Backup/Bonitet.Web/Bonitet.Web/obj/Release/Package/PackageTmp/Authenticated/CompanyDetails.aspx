        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="btn-group" role="group">
                        <button runat="server" id="short_blokada" type="button" class="btn btn-default" data-toggle="modal" onclick="ResetFieldsBlokada()" data-target="#blokada_modal">Провери блокада</button>
                    </div>
                </div>
            </div>
        </div>
