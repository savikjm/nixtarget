<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="EditCurrentYear.aspx.cs" Inherits="Bonitet.Web.Admin.EditCurrentYear" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-6 form-horizontal">
                        <div class="form-group">
                            <label class="control-label col-sm-4" for="c_year">Година: </label>
                            <div class="btn-group col-sm-6">
                                <asp:TextBox CssClass="form-control" runat="server" ID="c_year" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="btn-group" >
                    ...
                    <div class="my_info">
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Тековна година</h3>
                            </div>
                            <div class="panel-body">
                                <div class="form-group">
                                    <label runat="server" id="error_text" class="control-label" >Грешка!</label>
