<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="GenerateReportForce.aspx.cs" Inherits="Bonitet.Web.Admin.GenerateReportForce" %>
                    ...
                    <div class="my_info">
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <h4 style="color:red;">Преземање од ЦРМ при секој обид</h4>
                            </div>
                            <div class="panel-body">
                                    <div class=" col-md-8 col-md-offset-2">
                                        <label for="c_embs">Година: </label>           
                                        <asp:TextBox CssClass="form-control forced_year" runat="server" ID="c_year" />
                                    </div>
                                    <div class=" col-md-8 col-md-offset-2">
                                    ...
                                    <div class="col-md-8 col-md-offset-2" style="margin-top: 20px;">
                                        ...
                                        <div class="col-md-6" style="padding: 0;">
                                            <a href="/Admin/CompanySearch.aspx?force=true" type="button" class="btn btn-default mybtn pull-right custom_btn">Назад</a>
                                        </div>
                                    </div>                          
                                </div>
                             </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default" id="generate_crm_pdf" onclick="GeneratePDF(1, true)">Да</button>
